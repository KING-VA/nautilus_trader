...
class SchwabExecutionClient(LiveExecutionClient):
    ...
    async def _submit_order(self, command: SubmitOrder) -> None:
        order = command.order
        # instrument = self._cache.instrument(order.instrument_id) # Removed unused var
    ...
    def _handle_order_activity_payload(self, order_data: Mapping[str, Any]) -> None:  # noqa: C901
    ...
    def _build_order_status_report(
        ...
        # order_list_id = None  # Removed unused var
        # contingency_type = ContingencyType.NO_CONTINGENCY # Removed unused var
        ...
        if order_type_enum in (OrderType.TRAILING_STOP_MARKET, OrderType.TRAILING_STOP_LIMIT):
            ...
            # trailing_offset = order_data.get("priceOffset") # Removed unused
            # trailing_offset_type = ... # Removed unused
        # else:
        # trailing_offset = None # Removed unused
        # trailing_offset_type = TrailingOffsetType.NO_TRAILING_OFFSET # Removed unused
